...
/*   Updated: 2019/04/16 17:05:55 by beduroul    ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
void    rev_parth(t_index index, t_option op, char **av, struct stat *buff)
{
    t_recu *list;
...
void browse_path(t_index index, t_option op, char **av, struct stat *buff)
{
    t_recu *list;
